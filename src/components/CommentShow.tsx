...
const ShowComment = ({ product }: { product: ProductModel }) => {
  return (
    <>
      {
        ...
        <div className="flex flex-col bg-neutral-100 w-11/12 rounded-xs">
          ...
          <p className="m-2">
            متن پیام اینجا وارد میشود که میتواند یه متن بلند باشد برای مثال لورم ایپسوم یک متن
            ساختگی هست برای کارهای گرافیکی
          </p>
          <div className="m-2">
