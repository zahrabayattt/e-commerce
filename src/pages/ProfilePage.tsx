    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-950 p-4 font-sans" dir="rtl">
      <Card className="w-full max-w-lg bg-white dark:bg-gray-900">
          ...
          <form>
            <div className="grid w-full items-center gap-4">
              ...
              <div className="flex flex-col space-y-1.5">
                ...
                <Input id="confirm-password" type="password" placeholder="تکرار رمز عبور خود را وارد نمایید" />
              </div>
            </div>
          </form>
        </CardContent>
        <CardFooter className="flex justify-between">
          {/* Button component */}
          <Button variant="default" size="lg">بروزرسانی</Button>
          <Button variant="outline" size="lg">سفارشات من</Button>
        </CardFooter>
      </Card>
    </div>
  );
